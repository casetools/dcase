package edu.casetools.dcase.extensions.io.mdiag2uppaal.mnta;

import java.io.IOException;

import org.modelio.metamodel.uml.infrastructure.ModelElement;

import edu.casetools.dcase.extensions.io.mdiag2uppaal.mnta.data.FakeData;
...
public class DeclarationsWriter {
	...
	writer.append("const int MAX_ITERATION = " + FakeData.MAX_ITERATION + ";\n");
	...
	if (!systemData.getNtrs().isEmpty())
	    writer.append("typedef int[0,NTR_NO-1]      id_ei;\n");
	...
	writer.append("const int EVENT_NO = " + FakeData.EVENT_NO + ";\n");
	...
	for (int i = 0; i < systemData.getStates().size(); i++) {
	    ...
	    writer.append(((ModelElement) systemData.getStates().get(i)).getTagValue(DCasePeerModule.MODULE_NAME,
