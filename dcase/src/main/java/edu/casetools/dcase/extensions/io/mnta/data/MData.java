package edu.casetools.dcase.extensions.io.mnta.data;
...
public class MData {
	...
	antecedentGroups = TableUtils.getInstance().getAllElementsStereotypedAs(antecedentGroups, DCasePeerModule.MODULE_NAME,
    ...
    public List<MObject> getAntecedentGroups() {
	return antecedentGroups;
    }

    public void setAntecedentGroups(List<MObject> antecedents) {
	this.antecedentGroups = antecedents;
    }
