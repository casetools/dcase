 ...
 */
public class StationarySensorTool extends ElementTool {
	...
	String name = I18nMessageService.getString("Names.StationarySensor");
	...
	return ElementUtils.getInstance().addStereotype(DCasePeerModule.MODULE_NAME, auxiliarElement, DCaseStereotypes.STEREOTYPE_STATIONARY_SENSOR);
    }
