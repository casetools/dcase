 ...
 * 
 */
package edu.casetools.dcase.modelio.diagrams.info.tools.relations;
 ...
 */
public class DisplaysTool extends RelationTool {
	...
	return acceptElement(DCasePeerModule.MODULE_NAME, target, DCaseStereotypes.STEREOTYPE_MESSAGE);
    }
	...
	return acceptElement(DCasePeerModule.MODULE_NAME, target, DCaseStereotypes.STEREOTYPE_MESSAGE_INTERFACE);
    }
	...
	return ElementUtils.getInstance().createDependency(DCaseModule.getInstance(), DCasePeerModule.MODULE_NAME, originElement, targetElement,
		DCaseStereotypes.STEREOTYPE_DISPLAYS);
    }
