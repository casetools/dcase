 ...
 */
public class InformsTool extends RelationTool {
    ...
    public boolean acceptFirstElement(IDiagramHandle representation, IDiagramGraphic target) {
	    stationary = acceptElement(DCasePeerModule.MODULE_NAME, target, DCaseStereotypes.STEREOTYPE_M_DATABASE);
	    mobile 	   = acceptElement(DCasePeerModule.MODULE_NAME, target, DCaseStereotypes.STEREOTYPE_ANDROID_REASONER);
    ...
    public boolean acceptSecondElement(IDiagramHandle representation, IDiagramGraphic source, IDiagramGraphic target) {
    	if(stationary)
    		return (acceptElement(DCasePeerModule.MODULE_NAME, target, DCaseStereotypes.STEREOTYPE_VERA_ACTUATOR) ||
    				acceptElement(DCasePeerModule.MODULE_NAME, target, DCaseStereotypes.STEREOTYPE_JAVA_ACTUATOR));
    	if (mobile)
        	return acceptElement(DCasePeerModule.MODULE_NAME, target, DCaseStereotypes.STEREOTYPE_ANDROID_ACTUATOR);
    	return false;
    }
