...
public class TestCaseMessagePropertyPage implements IPropertyContent {

    private static final Logger logger = Logger.getLogger(TestCaseMessagePropertyPage.class.getName());
