 ...
 */
public class VeraActuatorTool extends ElementTool {
	...
	String name = I18nMessageService.getString("Names.VeraActuator");
	...
	return ElementUtils.getInstance().addStereotype(DCasePeerModule.MODULE_NAME, auxiliarElement, DCaseStereotypes.STEREOTYPE_VERA_ACTUATOR);
    }
