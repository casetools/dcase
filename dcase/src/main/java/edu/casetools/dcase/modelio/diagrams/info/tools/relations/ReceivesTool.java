 ...
 */
public class ReceivesTool extends RelationTool {
	...
	return acceptElement(RCasePeerModule.MODULE_NAME, target, RCaseStereotypes.STEREOTYPE_USER_PROFILE);
    }
	...
	return ElementUtils.getInstance().createDependency(DCaseModule.getInstance(), DCasePeerModule.MODULE_NAME, originElement, targetElement,
		DCaseStereotypes.STEREOTYPE_RECEIVES);
    }
