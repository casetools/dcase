...
public class ImmediatePastOperatorTool extends ElementTool {
    ...
    public MObject createOwnElement(IModelingSession session, MObject element) {
		...
		auxiliarElement = ElementUtils.getInstance().addStereotype(DCasePeerModule.MODULE_NAME, auxiliarElement, DCaseStereotypes.STEREOTYPE_IMMEDIATE_PAST_OPERATOR);
