 ...
 * 
 */
package edu.casetools.dcase.modelio.diagrams.reasoning.tools.relations;
 ...
 */
public class ProduceTool extends RelationTool {
	...
	return acceptElement(DCasePeerModule.MODULE_NAME, target, DCaseStereotypes.STEREOTYPE_MODELLING_RULE) ||
			acceptElement(DCasePeerModule.MODULE_NAME, target, DCaseStereotypes.STEREOTYPE_ANTECEDENT_GROUP);
    }
	...
	return acceptElement(DCasePeerModule.MODULE_NAME, target, DCaseStereotypes.STEREOTYPE_CONTEXT_STATE) || 
			acceptElement(DCasePeerModule.MODULE_NAME, target, DCaseStereotypes.STEREOTYPE_SENSOR_INFORMATION);
    }
	...
	return ElementUtils.getInstance().createDependency(DCaseModule.getInstance(), DCasePeerModule.MODULE_NAME, originElement, targetElement,
		DCaseStereotypes.STEREOTYPE_PRODUCE);
    }
