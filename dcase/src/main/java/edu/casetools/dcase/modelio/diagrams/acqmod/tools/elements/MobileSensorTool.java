...
public class MobileSensorTool extends ElementTool {
	...
	String name = I18nMessageService.getString("Names.MobileSensor");
	...
	Class auxiliarElement = ElementUtils.getInstance().createClass(DCaseModule.getInstance(), adaptElement(element), session, name,
		...
		return ElementUtils.getInstance().addStereotype(DCasePeerModule.MODULE_NAME, auxiliarElement, DCaseStereotypes.STEREOTYPE_MOBILE_SENSOR);
    }
