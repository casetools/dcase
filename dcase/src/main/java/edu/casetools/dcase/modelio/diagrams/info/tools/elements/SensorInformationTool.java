 ...
 */
public class SensorInformationTool extends ElementTool {
	...
	String name = I18nMessageService.getString("Names.SensorInformation");
	
	return ElementUtils.getInstance().createClass(DCaseModule.getInstance(), adaptElement(element), session, name,
			DCaseStereotypes.STEREOTYPE_SENSOR_INFORMATION);
    }
