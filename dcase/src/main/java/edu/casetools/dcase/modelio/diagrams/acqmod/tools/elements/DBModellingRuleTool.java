 ...
 */
public class DBModellingRuleTool extends ElementTool {
	...
	String name = I18nMessageService.getString("Names.DBModellingRule");
	...
	Class auxiliarElement = ElementUtils.getInstance().createClass(DCaseModule.getInstance(), adaptElement(element), session, name,
		...
		return ElementUtils.getInstance().addStereotype(DCasePeerModule.MODULE_NAME, auxiliarElement, DCaseStereotypes.STEREOTYPE_DB_MODELLING_RULE);
    }
