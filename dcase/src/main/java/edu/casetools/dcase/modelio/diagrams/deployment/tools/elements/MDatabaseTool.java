 ...
 */
public class MDatabaseTool extends ElementTool {
	...
	String name = I18nMessageService.getString("Names.MDatabase");
	...
	return ElementUtils.getInstance().addStereotype(DCasePeerModule.MODULE_NAME, auxiliarElement, DCaseStereotypes.STEREOTYPE_M_DATABASE);
    }
