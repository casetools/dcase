 ...
 */
public class AndroidReceiverTool extends ElementTool {
	...
	String name = I18nMessageService.getString("Names.AndroidReceiver");
	...
	return ElementUtils.getInstance().addStereotype(DCasePeerModule.MODULE_NAME, auxiliarElement, DCaseStereotypes.STEREOTYPE_ANDROID_RECEIVER);
    }
