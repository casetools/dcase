 ...
 * element.
 */
public abstract class LifelineTool extends DefaultBoxTool {
    private static final Logger logger = Logger.getLogger(LifelineTool.class.getName());
     ...
     * @return the m object
     */
    protected abstract Lifeline createOwnLifeline(IModelingSession session, MObject element);
	...
	Lifeline createdElement = createOwnLifeline(session, element);
