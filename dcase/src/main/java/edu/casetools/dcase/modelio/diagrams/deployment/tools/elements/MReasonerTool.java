 ...
 */
public class MReasonerTool extends ElementTool {
	...
	String name = I18nMessageService.getString("Names.MReasoner");
	...
	return ElementUtils.getInstance().addStereotype(DCasePeerModule.MODULE_NAME, auxiliarElement, DCaseStereotypes.STEREOTYPE_M_REASONER);
    }
